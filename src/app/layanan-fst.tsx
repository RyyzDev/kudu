...
export default function LayananFSTScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#f4f4f0] items-center justify-center">
      ...
      <Feather name="cpu" size={48} color="#999" />
      <Text className="font-black text-black/30 text-xl uppercase mt-4 tracking-widest">Layanan FST</Text>
